...
./clambback server.json -l server.log &
PID3="$!"

./clambback -t client.json
./clambback client.json -l client.log &
PID4="$!"

./clambback -t forward.json
./clambback forward.json -l forward.log &
PID5="$!"
